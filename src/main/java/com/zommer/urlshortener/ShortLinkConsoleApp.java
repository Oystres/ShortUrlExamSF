package com.zommer.urlshortener;
...
public class ShortLinkConsoleApp {
    ...
    private static final com.zommer.urlshortener.ShortLinkService ShortLinkService = new ShortLinkService(new ShortLinkRepository());
    private static final com.zommer.urlshortener.UserService UserService = new UserService(new UserRepository());
